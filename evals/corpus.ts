...
export const goldCases = [
  ...
  },
  {
    ...
    line: 138,
    name: null,
    rationale: "A committed Query-backed course identity causes one mark-read mutation; Query remains the canonical owner.",
    target: "genie-courses",
  },
  {
    action: "review-effect",
    ...
    line: 155,
    name: null,
    rationale: "The Tabby constructor requires its committed DOM target and exposes no proven disposer in the local contract.",
    target: "genie-courses",
  },
  {
    action: "keep-effect",
  ...
  },
  {
    ...
    line: 141,
    name: null,
    rationale: "Hydration persistence is replay-safe through its module guard; useMount would suppress the repository's required Strict Mode replay.",
    target: "genie-courses",
  },
  {
    action: "keep-effect",
  ...
  },
  {
    ...
    line: 79,
    name: null,
    rationale: "Adjacent playback-token prefetch is TanStack Query work driven by React lesson props.",
    target: "genie-courses",
  },
  {
    action: "review-effect",
    ...
    line: 153,
    name: null,
    rationale: "The keyed lesson scroller must be committed before its idempotent reset; once-only mount semantics are not intended.",
    target: "genie-courses",
  },
  {
    action: "keep-effect",
  ...
  },
  {
    ...
    line: 56,
    name: null,
    rationale: "The active command must exist in committed DOM before scrollIntoView runs.",
    target: "genie-courses",
  },
  {
    action: "keep-effect",
  ...
  },
  {
    ...
    line: 20,
    name: null,
    rationale: "Session-derived React props synchronize to the external Sentry SDK after commit.",
    target: "genie-courses",
  },
  {
    action: "review-effect",
    ...
    line: 57,
    name: null,
    rationale: "Adjacent-page prefetch belongs to TanStack Query and follows React page availability props.",
    target: "genie-courses",
  },
  {
    action: "keep-effect",
  ...
  },
  {
    ...
    line: 38,
    name: null,
    rationale: "React cleanup cancels an event-created clipboard timer at every lifetime boundary; useUnmount would suppress required Strict Mode cleanup.",
    target: "genie-courses",
  },
  {
    action: "review-effect",
    ...
    line: 414,
    name: null,
    rationale: "Each row owns its clipboard timer for the full React lifetime; once-only cleanup is neither intended nor approved.",
    target: "genie-courses",
  },
  {
    action: "keep-effect",
  ...
  },
  {
    ...
    line: 309,
    name: null,
    rationale: "React cleanup invalidates in-flight BNPL work for every course-view lifetime; useUnmount can admit stale Strict Mode completion.",
    target: "genie-courses",
  },
  {
    action: "keep-effect",
