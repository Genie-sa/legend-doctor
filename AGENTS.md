...
Run the typecheck, unit suite, and full pinned corpus after each detector phase. Report action deltas for every app, including zero-change apps. Keep uncertain opportunities as explicit non-enforced labels instead of weakening the rule.

Read `evals/README.md` before changing corpus targets, labels, or scoring policy.
