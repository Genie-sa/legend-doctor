...
// export and the production-boundary file gate was rewritten (see below).
//
...
// Vendored change: the upstream gate required a monorepo `apps/` or
// `packages/` prefix. Here all source is production except tests and scripts.
