...
// export and an upstream-internal incident anecdote was dropped.
//
...
// with the union with no compiler signal — a newly added member falls through
// the lookup instead of failing typecheck.
//
